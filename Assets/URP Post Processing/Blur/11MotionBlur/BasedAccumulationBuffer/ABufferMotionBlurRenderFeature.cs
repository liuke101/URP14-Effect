...
public class ABufferMotionBlurRenderFeature : ScriptableRendererFeature
{
    /// <summary>
    /// 渲染参数
    /// </summary>
    ...
    {
        [Range(0.0f, 0.9f)] public float blurTrain = 0.5f; //模糊拖尾,不能为1，放置拖尾效果完全替代当前帧的渲染效果
    }
    
    private ABufferMotionBlurRenderPass m_renderPass; //RenderPass
    ...
    public override void Create()
    {
        ...
        //创建RenderPass
        m_renderPass = new ABufferMotionBlurRenderPass(settings.commandBufferTag, settings.profilerTag, settings.renderPassEvent,
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        {
            //设置RenderPass参数
            m_renderPass.SetRenderPass(renderer.cameraColorTargetHandle,parameters.blurTrain);
