...
public class HeightFogRenderFeature : ScriptableRendererFeature
{
    ...
    public class RenderParameters
    {
        ...
        public float fogStart = 0.0f; //雾起始高度
        public float fogEnd = 2.0f; //雾终止高度
    }

    private HeightFogRenderPass m_renderPass; //RenderPass
    ...
    public class RenderSettings
    {
        ...
        //profiler标签名
        public string profilerTag = "HeightFogPass";
    ...
    public override void Create()
    {
        ...
        //创建RenderPass
        m_renderPass = new HeightFogRenderPass(settings.commandBufferTag, settings.profilerTag, settings.renderPassEvent,
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        {
            //设置RenderPass参数
            m_renderPass.SetRenderPass(renderer.cameraColorTargetHandle, parameters.fogDensity, parameters.fogColor, parameters.fogStart, parameters.fogEnd);
