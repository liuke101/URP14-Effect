...
public class CustomRenderPass : ScriptableRenderPass
{
    ...
    private RenderStateBlock m_renderStateBlock; //渲染状态块
    #endregion
    ...
    /// 深度设置
    /// </summary>
    /// <param name="writeEnabled">是否写入深度</param>
    /// <param name="function">深度比较函数</param>
    ...
    /// 模板设置
    /// </summary>
    /// <param name="stencilReference">模板参考值</param>
    /// <param name="compareFunction">模板比较函数</param>
    /// <param name="passOp">模板测试通过时使用的模板操作</param>
    /// <param name="failOp">模板测试失败时使用的模板操作</param>
    /// <param name="zFailOp">当模板测试因深度而失败时使用的模板操作</param>
    public void SetStencilState(int stencilReference, CompareFunction compareFunction, StencilOp passOp, StencilOp failOp, StencilOp zFailOp)
    {
