...
public class LuminanceTextureRenderFeature : ScriptableRendererFeature
{
    /// <summary>
    /// 渲染参数
    /// </summary>
    ...
    public class RenderParameters
    {
        ...
        [Range(0.0f, 10.0f)] 
        public float LightDarkIntensity = 1.0f; //明暗强度
        public Material waterMaterial;
    }

    private LuminanceTextureRenderPass m_renderPass; //RenderPass
    ...
    public class RenderSettings
    {
        ...
        //profiler标签名
        public string profilerTag = "LuminanceTexture Pass";
    ...
    public override void Create()
    {
        ...
        //创建RenderPass
        m_renderPass = new LuminanceTextureRenderPass(settings.commandBufferTag, settings.profilerTag, settings.renderPassEvent,
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        if (renderingData.cameraData.postProcessEnabled && renderingData.cameraData.cameraType == CameraType.Game)
        {
            ...
            m_renderPass.SetRenderPass(renderer.cameraColorTargetHandle, parameters.iterations, parameters.blurRadius,
                parameters.downSample, parameters.luminanceThreshold, parameters.LightDarkIntensity, parameters.waterMaterial);
