...
public class DepthFogRenderFeature : ScriptableRendererFeature
{
    ...
    private DepthFogRenderPass m_renderPass; //RenderPass
    ...
    public class RenderSettings
    {
        ...
        //profiler标签名
        public string profilerTag = "DepthFogPass";
    ...
    public override void Create()
    {
        ...
        //创建RenderPass
        m_renderPass = new DepthFogRenderPass(settings.commandBufferTag, settings.profilerTag, settings.renderPassEvent,
