...
public class ScreenSpaceReflectRenderPass : ScriptableRenderPass
{
    #region 渲染设置
    ...
    // 构造函数
    //------------------------------------------------------
    public ScreenSpaceReflectRenderPass(string commandBufferTag, string profilerTag,RenderPassEvent renderPassEvent,string[] shaderTags,RenderQueueType renderQueueType, int layerMask, Material blitMaterial)
    {
        #region 渲染设置相关参数
        base.profilingSampler = new ProfilingSampler(nameof(ScreenSpaceReflectRenderPass));
