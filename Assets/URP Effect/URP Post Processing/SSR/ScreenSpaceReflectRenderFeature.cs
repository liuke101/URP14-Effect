...
public class ScreenSpaceReflectRenderFeature : ScriptableRendererFeature
{
    /// <summary>
    /// 渲染参数
    /// </summary>
    ...
    public class RenderSettings
    {
        ...
        //profiler标签名
        public string profilerTag = "ScreenSpaceReflect Pass";
    ...
    public override void Create()
    {
        ...
        //this.name = "ScreenSpaceReflectRF";
        ...
        //创建RenderPass
        m_renderPass = new ScreenSpaceReflectRenderPass(settings.commandBufferTag, settings.profilerTag, settings.renderPassEvent,
