...
public class GodRayRenderFeature : ScriptableRendererFeature
{
    ...
    private GodRayRenderPass m_renderPass;
    ...
    public override void Create()
    {
        ...
        //创建RenderPass
        m_renderPass = new GodRayRenderPass(m_blitMaterial);
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        {
            //设置RenderPass参数
            m_renderPass.SetRenderPass(renderer.cameraColorTargetHandle, iterations, blurRadius, downSample, luminanceThreshold, bloomIntensity,radialCenter,radialOffsetIterations);
