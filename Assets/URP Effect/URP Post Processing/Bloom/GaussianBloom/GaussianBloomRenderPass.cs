...
public class GaussianBloomRenderPass : ScriptableRenderPass
{
    ...
    // //设置RenderPass参数
    //------------------------------------------------------
    public void SetRenderPass(RTHandle colorHandle, int iterations, float bloomRadius, int downSample, float luminanceThreshold, float bloomIntensity)
    {
        m_cameraRT = colorHandle;
        m_iterations = iterations;
        m_bloomRadius = bloomRadius;
