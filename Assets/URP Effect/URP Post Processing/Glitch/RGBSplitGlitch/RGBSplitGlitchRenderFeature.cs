...
public class RGBSplitGlitchRenderFeature : ScriptableRendererFeature
{
    ...
    {
        [Range(0,1)]
        public float splitIntensity; //强度
        public float amplitude; //振幅
    }

    private RGBSplitGlitchRenderPass m_renderPass; //RenderPass
    ...
    public class RenderSettings
    {
        ...
        //profiler标签名
        public string profilerTag = "RGBSplitGlitch Pass";
    ...
    public override void Create()
    {
        ...
        //创建RenderPass
        m_renderPass = new RGBSplitGlitchRenderPass(settings.commandBufferTag, settings.profilerTag,
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        {
            //设置RenderPass参数
            m_renderPass.SetRenderPass(renderer.cameraColorTargetHandle, parameters.splitIntensity,parameters.amplitude);
