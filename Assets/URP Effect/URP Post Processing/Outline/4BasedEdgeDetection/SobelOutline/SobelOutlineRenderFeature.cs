...
public class SobelOutlineRenderFeature : ScriptableRendererFeature
{
    ...
    private SobelOutlineRenderPass m_renderPass; //RenderPass
    ...
    public class RenderSettings
    {
        ...
        //profiler标签名
        public string profilerTag = "SobelOutlinePass";
    ...
    public override void Create()
    {
        ...
        //创建RenderPass
        m_renderPass = new SobelOutlineRenderPass(settings.commandBufferTag, settings.profilerTag, settings.renderPassEvent,
